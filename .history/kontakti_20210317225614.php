...
<section>
  <div class="containerc">
    <form id="contact validate-form"  method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
      <h3>CONTACT</h3>
      <h4>Contact me down below!</h4>
      <fieldset>
        <input placeholder="Your name" type="text" name="name" validate-input" data-validate="Email valide : ex@abc.xyz" tabindex="1" required autofocus>
      </fieldset>
      <fieldset>
